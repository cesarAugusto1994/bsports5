...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="box box-solid">
      ...
      <form class="form-horizontal" method="post" action="{{ route('eventos.update', $evento->id) }}" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="{{ $evento->titulo }}" name="titulo" id="titulo" placeholder="Titulo" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" name="conteudo" rows="8">{{ $evento->conteudo }}</textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="link" name="link" value="{{ $evento->link }}" placeholder="Link">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="video" name="video" value="{{ $evento->video }}" placeholder="Video">
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <div class="checkbox">
                <label>
                  <input type="checkbox" value="1" {{ $evento->ativo ? 'checked' : '' }} name="ativo"/> Ativo
                </label>
              </div>
            </div>
          </div>
