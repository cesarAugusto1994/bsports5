                ...
                <div class="row proximas-partidas">
                    ...
                    <div class="col-md-12">
                        <ul class="nav" role="tablist">
                          @foreach($partidasPorCategoria as $key => $itens)
                            <li style="float:left;" role="presentation" class="{{ $loop->index == 0 ? 'active' : '' }}">
                              <a class="tab-proximas-partidas" href="#news-tab-{{ $loop->index }}" aria-controls="news-tab-{{ $loop->index }}" role="tab" data-toggle="tab">{{ $key }}</a></li>
                          @endforeach
                        </ul>
                    </div>
                </div>
